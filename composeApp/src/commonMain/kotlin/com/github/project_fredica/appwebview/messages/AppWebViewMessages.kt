...
object AppWebViewMessages {
    val all by lazy {
        listOf(
            ...
            GetSessionTokenJsMessageHandler(),
            InstanceInitJsMessageHandler(),
            CheckBilibiliCredentialJsMessageHandler(),
            TryRefreshBilibiliCredentialJsMessageHandler(),
            GetBilibiliAccountPoolJsMessageHandler(),
            SaveBilibiliAccountPoolJsMessageHandler(),
            CheckBilibiliIpJsMessageHandler(),
            GetBilibiliAccountInfoJsMessageHandler(),
            FetchBilibiliAccountInfoJsMessageHandler(),
